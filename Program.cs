...
//noi non abbiamo gli array dinamici, quindi lo iniziamo con una lista
...
//alcune prove
//int[] v10000 = new int[10000];
//Purtroppo non funziona Array.Fill(v10000, () => rng.Next(0, 100));

//in questo modo funziona e quindi ho riempito un array di valori casuali
int[] v10000 = Enumerable.Range(0, 10000).Select(n => rng.Next(0, 100)).ToArray();

//é ovvio che stiamo parlando di "soluzioni stilistiche"
//che nulla cambiano rispetto al beneamato ciclo for
int[] v1_10000 = new int[10000];
...
Console.WriteLine(media / v1_10000.Length);
